        ...
        <div class="md:w-1/2">
            <div class="card">
                ...
                <div class="flex gap-2">
                    ...
                    <Button label="Messages" icon="pi pi-users" severity="warn" badge="8" badgeClass="p-badge-danger" />
                </div>
        ...
        <div class="md:w-1/2">
            ...
            <div class="card">
                ...
                <div class="flex items-center flex-col sm:flex-row gap-2">
                    ...
                    <Chip label="Comedy" />
                    <Chip label="Mystery" />
                    <Chip label="Thriller" :removable="true" />
                </div>
                ...
                <div class="flex items-center flex-col sm:flex-row gap-2">
                    ...
                    <Chip label="Microsoft" icon="pi pi-microsoft" :removable="true" />
                </div>
