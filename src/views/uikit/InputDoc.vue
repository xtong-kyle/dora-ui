    ...
    <Fluid class="flex flex-col md:flex-row gap-8">
        <div class="md:w-1/2">
            <div class="card flex flex-col gap-4">
                ...
                <InputNumber v-model="inputNumberValue" showButtons mode="decimal" />
            </div>
        ...
        <div class="md:w-1/2">
            ...
            <div class="card flex flex-col gap-4">
                ...
                <MultiSelect v-model="multiselectValue" :options="multiselectValues" optionLabel="name" display="chip" placeholder="Select Countries" :filter="true">
